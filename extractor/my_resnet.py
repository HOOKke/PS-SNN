...
from extractor.tools import pooling

logger = logging.getLogger(__name__)


# -> downsample use padding (when channels are increased)
...
# -> downsample use conv-layer (when channels are increased)
...
class CifarResNet(nn.Module):
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        if kwargs:
            logger.info("Unused kwargs: {}.".format(kwargs))
